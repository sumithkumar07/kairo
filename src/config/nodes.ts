...
export const AVAILABLE_NODES_CONFIG: AvailableNodeType[] = [
  ...
  },
  {
    ...
    icon: UserPlus,
    description: 'Creates a new contact in HubSpot (simulated). Requires HubSpot API Key.',
    category: 'integrations',
    isAdvanced: true,
    ...
    configSchema: {
      ...
      simulated_config: { label: 'Simulated Output (JSON)', type: 'json', placeholder: '{"vid": 12345, "isNew": true}', helperText: 'Mock HubSpot response for simulation mode.', required: true },
      ...GENERIC_RETRY_CONFIG_SCHEMA,
      ...GENERIC_ON_ERROR_WEBHOOK_SCHEMA,
    },
    inputHandles: ['input'],
  ...
  },
  {
    ...
    icon: Smartphone,
    description: 'Sends an SMS message using Twilio (simulated). Requires Twilio credentials.',
    category: 'integrations',
    isAdvanced: true,
  ...
  },
  {
    ...
    icon: Github,
    description: 'Creates an issue in a GitHub repository (simulated). Requires GitHub Token.',
    category: 'integrations',
    isAdvanced: true,
  ...
  },
  {
    ...
    icon: UploadCloud,
    description: 'Uploads a file to a Dropbox path (simulated). Requires Dropbox Token.',
    category: 'integrations',
    isAdvanced: true,
    ...
    configSchema: {
      ...
      token: { label: 'Dropbox Access Token', type: 'string', placeholder: '{{credential.DropboxToken}}', required: true },
      simulated_config: { label: 'Simulated Output (JSON)', type: 'json', placeholder: '{"name": "file.txt", "path_display": "/file.txt"}', helperText: 'Mock Dropbox response for simulation mode.', required: true },
      ...GENERIC_RETRY_CONFIG_SCHEMA,
      ...GENERIC_ON_ERROR_WEBHOOK_SCHEMA,
    },
    inputHandles: ['input'],
