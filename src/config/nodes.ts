...
export const AVAILABLE_NODES_CONFIG: AvailableNodeType[] = [
  ...
  },
  {
    ...
    icon: CreditCard,
    description: 'Creates a Stripe Payment Link. Note: This node is simulated. A real implementation would require a Stripe API Key.',
    category: 'integrations',
    isAdvanced: true,
  ...
  },
  {
    ...
    icon: UserPlus,
    description: 'Creates a new contact in HubSpot. Note: This node is simulated. A real implementation would require a HubSpot API Key.',
    category: 'integrations',
    isAdvanced: true,
  ...
  },
  {
    ...
    icon: Smartphone,
    description: 'Sends an SMS message using Twilio. Note: This node is simulated. A real implementation would require Twilio credentials.',
    category: 'integrations',
    isAdvanced: true,
  ...
  },
  {
    ...
    icon: TrendingUp,
    description: 'Fetches trending videos from YouTube. Note: This node is simulated. Requires a YOUTUBE_API_KEY for a real implementation.',
    category: 'integrations', 
    isAdvanced: true,
