...
export const AVAILABLE_NODES_CONFIG: AvailableNodeType[] = [
  ...
  },
  {
    ...
    icon: MessageSquare,
    description: 'Posts a message to a Slack channel. Requires Slack Bot Token.',
    category: 'integrations',
    isAdvanced: true,
    ...
    configSchema: {
      ...
      token: { label: 'Slack Bot Token', type: 'string', placeholder: '{{credential.SlackBotToken}}', helperText: "Use {{credential.SlackBotToken}} for a managed credential. Live mode requires the SLACK_BOT_TOKEN environment variable.", required: true },
  ...
  },
  {
    ...
    icon: Bot,
    description: 'Generates a chat completion using OpenAI models.',
    category: 'ai',
    isAdvanced: true,
    ...
    configSchema: {
      ...
      apiKey: { label: 'OpenAI API Key', type: 'string', placeholder: '{{credential.OpenAIKey}}', helperText: "Use {{credential.OpenAIKey}} for a managed credential. Live mode requires the OPENAI_KEY environment variable.", required: true },
  ...
  },
  {
    ...
    icon: Github,
    description: 'Creates an issue in a GitHub repository. Requires GitHub Token.',
    category: 'integrations',
    isAdvanced: true,
    ...
    configSchema: {
      ...
      token: { label: 'GitHub Token', type: 'string', placeholder: '{{credential.GitHubToken}}', helperText: 'A Personal Access Token with repo scope. Live mode requires the GITHUB_TOKEN environment variable.', required: true },
