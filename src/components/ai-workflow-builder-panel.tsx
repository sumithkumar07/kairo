...
import { Zap, Bot, MessageSquareText, Sparkles, Loader2, Minus, Plus, Undo2, Redo2, File as FileIcon, FolderOpen, Save, FilePlus, UploadCloud, DownloadCloud, PanelLeftClose, PanelLeftOpen } from 'lucide-react';
