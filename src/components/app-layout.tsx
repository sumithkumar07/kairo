...
import { Workflow, History, Cpu, Settings, LogOut, User, Menu, LayoutDashboard, Compass, FileText, Shield, Activity, CreditCard, Calendar, BarChart3 } from 'lucide-react';
