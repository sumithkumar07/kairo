...
- 'config': A JSON object for node-specific parameters.
    ...
    - Specific Node Config Examples:
        ...
        - 'manualInput': For representing human interaction. Config must include:
            ...
            - 'inputFieldsSchema': A JSON string defining an array of objects for form fields. Each object has this structure: '{ "id": "field_name", "label": "Field Label", "type": "text" | "textarea" | "number" | "boolean" | "select", "options": ["opt1", "opt2"] (if type is select), "defaultValue": "...", "placeholder": "...", "required": true/false }'.
